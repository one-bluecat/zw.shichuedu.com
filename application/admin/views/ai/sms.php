<div class="main layui-body">
    <div class="main-header">
        <div class="layui-breadcrumb">
            <a href="/admin.php/audition/index"><i class="fa fa-dashboard"></i> 控制台 / 短信列表</a>
        </div>
    </div>
        ...
        <div class="layui-fluid">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="data-list" data-url="<?php echo site_url('ai/smslists'); ?>">
...
<script>
    function export_excel(){
        var url = '/admin.php/ai/smslists?is_export=1';
        console.log(url);
