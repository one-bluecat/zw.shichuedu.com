<div class="main layui-body">
    <div class="main-header">
        <div class="layui-breadcrumb">
            <a href="/admin.php/textbookfeedback/index"><i class="fa fa-dashboard"></i> 控制台 /教材版本反馈</a>
        </div>
    </div>
    <div class="main-content">
        <div class="layui-fluid">
            <div class="layui-card">
                <div class="layui-card-header">教材版本反馈</div>
                <div class="layui-card-body">
                    <div class="data-list" data-url="<?php echo site_url('textbookfeedback/lists?city='.$_REQUEST['city'].'&area='.$_REQUEST['area'].'&subject='.$_REQUEST['subject'].'&study_section='.$_REQUEST['study_section']); ?>">
                        <form class="layui-form inline-form">
                            <div class="pull-left">
<!--                                <div class="layui-inline">-->
<!--                                    <button class="layui-btn layui-btn-normal layui-btn-sm ajax-form" data-url="--><?php //echo site_url('textbook/add'); ?><!--"><i class="layui-icon">&#xe61f;</i> 新增</button>-->
<!--                                </div>-->
                            </div>
