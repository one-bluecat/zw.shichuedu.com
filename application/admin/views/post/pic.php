<div class="main layui-body">
    <div class="main-header">
        <div class="layui-breadcrumb">
            <a href=""><i class="fa fa-dashboard"></i> 控制台 / 职位首页banner上传</a>
        </div>
    </div>
    <div class="main-content">
        <div class="layui-fluid">
            <div class="layui-card">
                <div class="layui-card-header">职位首页banner上传</div>
                <div class="layui-card-body">
                    ...
                    <div class="site-text site-block">
                        <form class="layui-form" action="/admin.php/post/do_pic" enctype="multipart/form-data" method="post" accept-charset="utf-8">
