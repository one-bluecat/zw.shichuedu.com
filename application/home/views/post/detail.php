    ...
    <div class="job_table">
        ...
        <div class="job_content zwtbxx">
            <table width="960"  border="0" cellSpacing="1" cellPadding="0" align="center">
                ...
                <tr><td>城区计划数</td><td><?php echo $detail['city_plan'];?></td></tr>
                <tr><td>乡镇计划数</td><td><?php echo $detail['town_plan'];?></td></tr>
                <tr><td>单列计划</td><td><?php echo $detail['single_plan'];?></td></tr>
                <tr style="background:#ececec;"><td>报名人数</td><td><?php echo $detail['apply_num'];?>（更新时间：<?php echo $system_config['zhiwei_newupdate_time'];?>）</td></tr>
                <tr style="background:#ececec;"><td>资格审查合格</td><td><?php echo $detail['pass_num'];?>（更新时间：<?php echo $system_config['zhiwei_newupdate_time'];?>）</td></tr>
                <tr style="background:#ececec;"><td>缴费人数</td><td><?php echo $detail['pay_num'];?>（更新时间：<?php echo $system_config['zhiwei_newupdate_time'];?>）</td></tr>
                ...
                <?php
                    if($detail['year'] == 2020||$detail['year'] == 2021){
                        ?>
...
<!--        </div>-->
    ...
    <div class="mzsm"><div><strong>免责声明：</strong>此职位信息来源安徽教师招考网，只为各位考生提供报名参考之用,最终数据请以安徽教师招考网正式公布为准。</div></div>
</div>
