<div class="box">
    <div class="gwysite"><span>您所在的位置：<a href="/">首页</a> &gt; <a href='<?php echo $position_info['city_url'];?>'><?php echo $position_info['city_name'];?></a> &gt; <a href='<?php echo $position_info['area_url'];?>'><?php echo $position_info['area_name'];?></a> &gt; <?php echo $position_info['company'];?></span></div>

    <!--职位内容开始-->
    <div class="job_table">
        <div class="job_title"><h1><?php echo $position_info['city_name'].$position_info['area_name'].$position_info['company'];?></h1>招聘考试职位表</div>
                ...
                <tbody>
                    ...
                    foreach ($list as $key=>$value){
                        ...
                        <tr>
                            ...
                            <td data-label='学历：'><?php echo $value['degree'];?></td>
                            ...
                            <td data-label='资审合格人数：'><?php echo $value['pass_num'];?></td>
                            <td><a target='_blank' href='/kscx/<?php echo $value['year'];?>/<?php echo $value['id'];?>.html' target='_blank' class='num table3'>详细</a></td>
                            <td><a class='redback num table4' href='javascript:;' id='duibi<?php echo $value['id'];?>' onclick=zwdb('<?php echo $value['id'];?>','1','高中语文')>对比</a></td>
                        </tr>
