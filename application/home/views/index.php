...
<div class="box">
    ...
    <div class="search mt15">
        <ul class="search_tab">
            <li class="cur">职位分类查询</li><!--<li>综合精确搜索</li>--><a href="/kscx/bmtj/<?php echo $year!=$system_config['year']?$year.".html":"";?>"><p>报名人数统计</p></a>
        </ul>
    ...
    <div class="i_jobcz">
        <h2>按地区-快速查找<?php echo $year;?>职位</h2>
        ...
        <div class="container">
            ...
            <div class="waterfall">
                ...
                foreach ($city_applyNum_list as $value){
                    ...
                    <div class='gszw'>
                        <h5>
                            <a class='dishi' href='/kscx/<?php echo $city_map[$value['province']]['en'].($year!=$system_config['year']?'/'.$year.'.php':"");?>/' title='<?php echo $system_config['year'];?>年安庆教师招聘考试职位表'><?php echo $city_map[$value['province']]['zh'];?></a>
                            <span style="color:#cc0000;">(<?php echo $value['post_num'];?>职位<?php echo $value['apply_num'];?>人)</span>
                            <a class='more' href='/kscx/<?php echo $city_map[$value['province']]['en'].($year!=$system_config['year']?'/'.$year.'.php':"");?>/'>更多</a>
                        </h5>
                        <div class='zwlst'>
                            <ul>
                                <?php
                                foreach ($value['top10_post_list'] as $item){
                                    ?>
                                    <li><a href='/kscx/<?php echo $city_map[$value['province']]['en'];?>/<?php echo $item['id'].($year!=$system_config['year']?'/'.$year.'.html':"");?>'><?php echo $item['company'];?></a></li>
                                <?php }
                                ?>
                            </ul>
                        </div>
            ...
            <div class="listrbarJz">
                ...
                <ul>
                    ...
                    foreach ($apply_order_list as $value){
                        ?>
                        <li><a title="<?php echo $value['post_name']?>" href="/kscx/<?php echo $value['year'].'/'.$value['id'];?>.html"><?php echo $value['alias_post_name'];?></a><span><?php echo $value['apply_num'];?></span></li>
                    <?php  }
                    ?>
                </ul>
            </div>
            <div class="listrbarZw">
                ...
                <ul>
                    ...
                    foreach ($compete_order_list as $value){
                        ?>
                        <li><a title="<?php echo $value['post_name']?>" href="/kscx/<?php echo $value['year'].'/'.$value['id'];?>.html"><?php echo $value['alias_post_name'];?></a><span><?php if(ceil($value['compete_rate']) === $value['compete_rate']){echo (int)$value['compete_rate'];}else{echo $value['compete_rate'];}?></span></li>
                    <?php  }
                    ?>
                </ul>
            </div>
            ...
            <div class="listrbarRs">
                ...
                <ul>
                    ...
                    foreach ($zhaokao_order_list as $value){
                        ?>
                        <li><a title="<?php echo $value['post_name']?>" href="/kscx/<?php echo $value['year'].'/'.$value['id'];?>.html"><?php echo $value['alias_post_name'];?></a><span><?php echo $value['num'];?></span></li>
                    <?php  }
                    ?>
                </ul>
            </div>
