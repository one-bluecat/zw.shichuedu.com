...
<meta charset="utf-8"/>
<title><?php echo $year; ?>
安徽教师招聘成绩排名|成绩查询|分数线查询系统</title>
<meta name='keywords' content='安徽教师成绩排名,安徽教师成绩查询,安徽教师招聘分数线'>
<meta name='description' content='安徽教师招网提供<?php echo $year; ?>
安徽教师招聘考试成绩排名、<?php echo $system_config['year']; ?>
安徽教师招聘成绩查询入口、<?php echo $system_config['year']; ?>
安徽教师招聘考试分数线及<?php echo $system_config['year']; ?>
安徽教师招聘入围面试分数线，更多安徽教师招聘报名信息请关注师出教育.' />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0"/>
<meta name="applicable-device" content="pc,mobile"/>
<link rel="shortcut icon" href="/resources/images/favicon.ico">
<link rel="stylesheet" type="text/css" href="/resources/static/home/css/4zwb.css"/>
...
<div class="ht_top">
	<div class="zt_top">
		<a href="http://www.shichuedu.com/">
		<div class="logo">
		</div>
		</a>
		<div class="topnav">
			<a href="http://www.shichuedu.com/">师出教育</a><a href="http://scwx.shichuedu.com/">网校</a><a href="http://www.ahteacher.com/">
			安徽教师招考网</a>
		</div>
	</div>
</div>
