...
<div class="box">
    ...
    <!--搜索结束-->
    <div class="job_table">
        <div class="job_title"><?php echo $system_config['year'];?>安徽教师招聘成绩排名全部学段学科数据汇总&nbsp;<span>【师出大数据】</span><a href="/paiming/stat/city">看全部地市</a></div>
                ...
                <?php  }else{
                    foreach ($list as $k=>$r){
                        ...
                        <tr <?php if($r['is_self']) echo 'style="color:red;"';?>>
                            ...
                            <td class=""><?php echo $r['study_section'];?></td>
                            <td class=""><?php echo $r['subject'];?></td>
