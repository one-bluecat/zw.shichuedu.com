...
<div class="box">
    <div class="gwysite">
        <span>您所在的位置：
            <a href="/paiming/shuju/home/<?php echo $year !=$system_config['year']?$year.'.html':"";?>">首页</a> &gt;
            <a href='/paiming/shuju/<?php echo $city_map[substr($detail['province'],0,4)]['en'];?>/<?php echo $year !=$system_config['year']?$year.'.php':"";?>'><?php echo $city_map[substr($detail['province'],0,4)]['zh'];?></a> &gt;
            <a href='/paiming/shuju/<?php echo $city_map[substr($detail['province'],0,4)]['en'];?>/<?php echo str_replace(' ','',pinyin($detail['area']));?>/<?php echo $year !=$system_config['year']?$year.'.html':"";?>'><?php echo $detail['area'];?></a> &gt;
            <a href='/paiming/shuju/<?php echo $city_map[substr($detail['province'],0,4)]['en'];?>/<?php echo $detail['id'];?>/<?php echo $year !=$system_config['year']?$year.'.html':"";?>'><?php echo $detail['company'];?></a> &gt; <?php echo $detail['post_name'];?>
        </span>
    </div>
    <!--职位内容开始-->
    <div class="job_table">
        <div class="job_title"><h1><?php echo $year;?>安徽教师招聘<?php echo $city_map[substr($detail['province'],0,4)]['zh'].$detail['company'].$detail['post_name'];?>成绩排名 <?php if($detail['lower_score']) echo ($year-1).'最低分数线 '.$detail['lower_score'];?></h1><?php if($detail['link']){echo$detail['link'];}?></div>
                ...
                <table width="960"  border="0" cellSpacing="1" cellPadding="0" align="center">
                    ...
                    <tr>
                        <td  colspan="8"><b><?php echo $detail['company'].$detail['post_name'];?>-<?php echo $detail['post_code'];?>-成绩排名</b>
                            <div class="htzwxq">招聘人数：<?php echo $detail['num'];?>；提交人数：<?php echo $detail['tijiao_num'];?>人；<a href="#zhiwei" target="_self">查看职位信息</a>。</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="zydnxs">姓名</td>
                        <td>教综成绩</td>
                        <td>专业课成绩</td>
                        <td>综合成绩</td>
                        <td>综合排名</td>
                        ...
                        if(!empty($list)){
                            foreach ($list as $key=>$item){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $item['jz_score'];?></td>
                                    <td><?php echo $item['zyk_score'];?></td>
                           ...
                           ?> <tr>
                                <td colspan="10">
                                    暂无数据，<span><a href="/lscx/index/">点击查看历年分数线</a></span>
                                </td>
                                </tr>
                    <?php    }
                        ?>
                    <tr>
                        <td colspan="8" style="text-align:center">
                            <b><a href="/paiming/shuju/home/<?php echo $year !=$system_config['year']?$year.'.html':"";?>">返回首页</a></b>  &nbsp;|
                            <b><a href="/paiming/shuju/<?php echo $city_map[substr($detail['province'],0,4)]['en']?>/<?php echo $year !=$system_config['year']?$year.'.php':"";?>" target="_blank"><?php echo $city_map[substr($detail['province'],0,4)]['zh']?></a></b>  &nbsp;|
                            <b><a href="/paiming/shuju/<?php echo $city_map[substr($detail['province'],0,4)]['en']?>/<?php echo str_replace(' ','',pinyin($detail['area']));?>/<?php echo $year !=$system_config['year']?$year.'.html':"";?>" target="_blank"><?php echo $detail['area'];?>成绩</a></b>  &nbsp;|
                            <b><a href="/paiming/shuju/search<?php echo $year !=$system_config['year']?$year:"";?>/" target="_blank">查询成绩</a></b>
                        </td>
                    </tr>
                    <tr><td colspan="8">
                            <!-- Baidu Button BEGIN -->
        ...
        <div class="job_content zwtbxx">
            <table width="960"  border="0" cellSpacing="1" cellPadding="0" align="center">
                ...
                if($detail['year'] == 2020){
                    ?>
                    <tr><td>是否高校毕业生计划</td><td><?php echo $detail['university_graduate_plan'];?></td></tr>
                <?php   }
                ?>
...
<!--                    <td><a href="http://www.zgteachers.com/e/search/result/?searchid=3570" class="num table5">--><?php //echo $system_config['year'];?><!--安徽教师招聘考试报名入口</a></td>-->
<!--                </tr>-->
                ...
                <tr><td colspan="4" style="text-align:center">
                        <b><a href="/paiming/shuju/<?php echo $year != $system_config['year']?$year:'';?>">返回首页</a></b>
<!--                        &nbsp;|-->
