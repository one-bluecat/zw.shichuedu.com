<div class="box">
    <div class="gwysite">
        <span>您所在的位置：<a href="/paiming/shuju/home/<?php echo $year !=$system_config['year']?$year.'.html':"";?>">首页</a> &gt;
    ...
    <!--职位内容结束-->
    <div class="mzsm">
        <div><strong>免责声明：</strong>此职位信息来源教师招聘网，只为各位考生提供报名参考之用,最终数据请以教师招聘网正式公布为准。</div>
    </div>
