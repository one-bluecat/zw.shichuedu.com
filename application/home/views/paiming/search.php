<div class="box">
    ...
    <div class="search mt15">
        ...
        <div class="sear_select">
            <form class="zwsTop" method="get" action="/paiming/shuju/search<?php echo $year;?>/">
                <input type="hidden" name="page" value="">
                <div class="select cur">
                    <ul>
                        <li><select id="kaoqu" name="kaoqu">
                                <option selected="" value="">--考区--</option>
                                <?php foreach($list['area_list'] as $key=>$r):?>
                                    <option value="<?php echo $key;?>" <?php if($_REQUEST['kaoqu'] == $key || $_REQUEST['kqid'] == $key) echo 'selected';?>><?php echo $city_map[$key]['zh'];?></option>
                                    <?php foreach($r as $re):?>
                                        <option value="<?php echo $re['province'];?>" <?php if($_REQUEST['kaoqu'] == $re['province'] || $_REQUEST['kqid'] == $re['province']) echo 'selected';?>>&nbsp;&nbsp;<?php echo $re['area'];?></option>
                                    <?php endforeach;?>
                                <?php endforeach;?>
                            </select></li>
                        <li>
                            <select id="xueduan" name="xueduan">
                                ...
                                foreach ($list['study_section_list'] as $item){
                                    ?>
                                    <option value="<?php echo $item['study_section'];?>" <?php if($_REQUEST['xueduan'] == $item['study_section']) echo 'selected';?>><?php echo $item['study_section'];?></option>
                                <?php }
                                ?>
                        ...
                        <li>
                            <select id="xueke" name="xueke">
                                ...
                                foreach ($list['subject_list'] as $value){
                                    ?>
                                    <option value="<?php echo $value['subject'];?>" <?php if($_REQUEST['xueke'] == $value['subject']) echo 'selected';?>><?php echo $value['subject'];?></option>
                                <?php  }
                                ?>
                            </select>
                        </li>
                        ...
                        <li>
                            <select id="xueli" name="xueli">
                                ...
                                foreach ($list['degree_list'] as $value){
                                    ?>
                                    <option value="<?php echo $value['degree'];?>" <?php if($_REQUEST['xueli'] == $value['degree']) echo 'selected';?>><?php echo $value['degree'];?></option>
                                <?php  }
                                ?>
                            </select>
                        </li>
                        <li>
                            <select id="zhuanye" name="zhuanye">
                                ...
                                foreach ($list['profession_list'] as $value){
                                    ?>
                                    <option value="<?php echo $value['profession'];?>" <?php if($_REQUEST['zhuanye'] == $value['profession']) echo 'selected';?>><?php echo $value['profession'];?></option>
                                <?php  }
                                ?>
                            </select>
                        </li>
                        <li>
                            <select id="nianling" name="nianling">
                                ...
                                foreach ($list['age_list'] as $value){
                                    ?>
                                    <option value="<?php echo $value['age'];?>" <?php if($_REQUEST['nianling'] == $value['age']) echo 'selected';?>><?php echo $value['age'];?></option>
                                <?php  }
                                ?>
                            </select>
                        </li>
        ...
        <table width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label='<?php echo $year-1;?>分数线：'><?php echo $value['lower_score'];?></td>
                    <td><a class="num table3" href="/paiming/shuju/<?php echo $value['year'];?>/<?php echo $value['id']; ?>.html">查看成绩排名</a></td>
                </tr>
