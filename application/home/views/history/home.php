...
<!--            <a href="/lscx/bmtj/"><p>报名人数统计</p></a>-->
    ...
    <div class="i_jobcz">
        ...
        <ul>
            <?php
            foreach ($city as $k=>$v){
                ?><li><a target='_blank' href='/lscx/<?php echo $v['en'];?><?php echo $year!=$system_config['year']?'/'.$year.'.php':'';?>'><?php echo $v['zh'];?></a></li>
            <?php  }
            ?>
        </ul>
    </div>
    <div class="gkdjs">
        <div class="gkdjs_t">
            <p><a href="http://scwx.shichuedu.com"><?php echo $system_config['year'];?>安徽教师统考</a><br>倒计<span class="lxftime"><script>document.write(DateDiff(nowt,"<?php  echo $system_config['last_time'];?>"));</script></span>天</p>
        </div>
        <div class="gkdjs_r">
        <p>
            ...
            <a href="http://www.zgteachers.com/e/search/result/?searchid=3365"><img src="http://zw.shichuedu.com/resources/static/home/img/gkrk_08.png">考试公告</a>
            <a href="http://www.zgteachers.com/e/search/result/?searchid=3426"><img src="http://zw.shichuedu.com/resources/static/home/img/gkrk_02.png">考试大纲</a>
            <a href="http://www.zgteachers.com/e/search/result/?searchid=3570"><img src="http://zw.shichuedu.com/resources/static/home/img/gkrk_03.png">报名入口</a>
            ...
            <a href="http://zw.shichuedu.com/kscx/rank<?php echo $year!=$system_config['year']?$year:'';?>/"><img src="http://zw.shichuedu.com/resources/static/home/img/gkrk_10.png">热门职位</a>
            ...
            <a href="http://www.zgteachers.com/e/search/result/?searchid=2767"><img src="http://zw.shichuedu.com/resources/static/home/img/gkrk_20.png">历年真题</a>
    ...
    <div class="mian">
        ...
        <div class="container">
            ...
            <div class="waterfall">
                ...
                foreach ($city_applyNum_list as $value){
                    ...
                    <div class='gszw'>
                        <h5>
                            <a class='dishi' href='/lscx/<?php echo $city_map[$value['province']]['en'];?><?php echo $value['year']!=$system_config['year']?'/'.$value['year'].'.php':'';?>' title='<?php echo $system_config['year'];?>年安庆教师招聘考试职位表'><?php echo $city_map[$value['province']]['zh'];?></a>
                            <span>(<?php echo $value['post_num'];?>职位<?php echo $value['apply_num'];?>人)</span>
                            <a class='more' href='/lscx/<?php echo $city_map[$value['province']]['en'];?><?php echo $value['year']!=$system_config['year']?'/'.$value['year'].'.php':'';?>'>更多</a>
                        </h5>
                        <div class='zwlst'>
                            <ul>
                                <?php
                                foreach ($value['top10_post_list'] as $item){
                                    ?>
                                    <li><a href='/lscx/<?php echo $city_map[$value['province']]['en'];?>/<?php echo $item['id'];?><?php echo $value['year']!=$system_config['year']?'/'.$value['year'].'.html':'';?>'><?php echo $item['company'];?></a></li>
                                <?php }
                                ?>
                            </ul>
                        </div>
        ...
        <div class="listrbar">
            <div class="listrbarJz">
                <h3><a href="/kscx/bmtj/<?php echo $year!=$system_config['year']?$year.'.html':'';?>">更多</a>报考热度排行</h3>
                <p><span>职位名称</span><span>报考人数</span></p>
                <ul>
                    <?php
                    foreach ($apply_order_list as $value){
                        ?>
                        <li><a title="小学英语" href="/lscx/<?php echo $value['year'].'/'.$value['id'];?>.html"><?php echo $value['post_name'];?></a><span><?php echo $value['apply_num'];?></span></li>
                    <?php  }
                    ?>
                </ul>
            </div>
            <div class="listrbarZw">
                <h3><a href="/kscx/bmtj/<?php echo $year!=$system_config['year']?$year.'.html':'';?>">更多</a>竞争比例排行</h3>
                <p><span>职位名称</span><span>竞争比</span></p>
                <ul>
                    <?php
                    foreach ($compete_order_list as $value){
                        ?>
                        <li><a title="小学英语" href="/lscx/<?php echo $value['year'].'/'.$value['id'];?>.html"><?php echo $value['post_name'];?></a><span><?php if(ceil($value['compete_rate']) == $value['compete_rate']){echo (int)$value['compete_rate'];}else{echo $value['compete_rate'];}?></span></li>
                    <?php  }
                    ?>
                </ul>
            </div>
            <div class="listrbarRs">
                <h3><a href="/kscx/bmtj/<?php echo $year!=$system_config['year']?$year.'.html':'';?>">更多</a>招考人数排行</h3>
                <p><span>职位名称</span><span>招考人数</span></p>
                <ul>
                    <?php
                    foreach ($zhaokao_order_list as $value){
                        ?>
                        <li><a title="小学英语" href="/lscx/<?php echo $value['year'].'/'.$value['id'];?>.html"><?php echo $value['post_name'];?></a><span><?php echo $value['num'];?></span></li>
                    <?php  }
                    ?>
                </ul>
            </div>
