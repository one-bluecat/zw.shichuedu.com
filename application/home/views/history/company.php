<div class="box">
    <div class="gwysite"><span>您所在的位置：<a href="/lscx/home/<?php echo $year !=$system_config['year']?$year.'.html':"";?>">首页</a> &gt; <a href='<?php echo $position_info['city_url'];?>'><?php echo $position_info['city_name'];?></a> &gt; <a href='<?php echo $position_info['area_url'];?>'><?php echo $position_info['area_name'];?></a> &gt; <?php echo $position_info['company'];?></span></div>

    <!--职位内容开始-->
    <div class="job_table">
        <div class="job_title"><h1><?php echo $year.$position_info['company'];?></h1>教师招聘成绩排名|成绩查询|分数线</div>
